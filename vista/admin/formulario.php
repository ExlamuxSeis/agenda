    ...
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Ingresar nuevo contacto</h6>
            </div>
                ...
                <div class="">
                    <div class="container" style="padding-top: 10px;">
                        <main class="form-signin w-100 m-auto">
                            <div class="container">
                                <form class="needs-validation" novalidate action="../../controlador/agregar.php" method="post" enctype="multipart/form-data">
                                    <div class="row mb-3">
                                        <label for="validationCustom01" class="col-sm-2 col-form-label">Nombre:</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required id="validationCustom01" name="nombre" placeholder="Ingresa tu nombre">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required name="paterno" id="validationCustom02" placeholder=" Ingresa tu apellido paterno">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" required name="materno" id="validationCustom03" placeholder="Ingresa tu apellido materno">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" name="telefono" required id="validationCustom04" placeholder="7321234321">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="email" class="form-control" required name="email" id="validationCustom05" placeholder="Ingresa tu correo electrónico">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-select" id="validationCustom06" name="categoria" required id="motivo">
